  ...
  return (
    <div className="relative overflow-hidden rounded-xl mb-1 select-none touch-none group">
      ...
      <div
        ...
        className={`relative z-10 w-full flex items-start gap-3 p-3.5 transition-all duration-300 cursor-pointer border border-transparent ${isActive
      ...
      >
        <div className="relative flex-shrink-0 w-[48px] h-[48px]">
          ...
          {conv.user.status === 'Online' && (
            <div className={`absolute bottom-0 right-0 w-3.5 h-3.5 border-[2px] rounded-full z-10 ${isActive ? 'bg-[#139d78] border-[#F3F3EE]' : 'bg-[#139d78] border-white'}`}></div>
          )}
        </div>
