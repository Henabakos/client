...
export const NewMessageModal: React.FC = () => {
  ...
  return (
    <div
      ref={modalRef}
      className={`absolute w-[320px] bg-white rounded-2xl shadow-[0_12px_48px_rgba(0,0,0,0.15)] border border-gray-100 overflow-hidden z-[90] animate-in fade-in zoom-in-95 duration-200 ${isMobile ? 'top-16 left-1/2 -translate-x-1/2' : 'top-16 left-32'
        }`}
    >
      <div className="p-5">
