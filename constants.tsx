...
export const MOCK_USERS: any[] = [
  ...
  },
  {
    id: '2',
    name: 'Yomi Immanuel',
    avatar: 'https://picsum.photos/seed/yomi/40/40',
    status: 'Online',
  ...
  },
  {
    id: '3',
    name: 'Bianca Nubia',
    avatar: 'https://picsum.photos/seed/bianca/40/40',
    status: 'Offline',
    lastMessage: 'anytime! my pleasure~',
    lastTime: '32 mins ago',
    unread: 0
  },
  {
    id: '4',
    name: 'Zender Lowre',
    avatar: 'https://picsum.photos/seed/zender/40/40',
    status: 'Online',
  ...
  },
  {
    id: '5',
    name: 'Palmer Dian',
    avatar: 'https://picsum.photos/seed/palmer/40/40',
    status: 'Offline',
...
export const ICONS = {
  ...
  Send: () => (
    <svg className="w-5 h-5 text-white transform rotate-45 -translate-y-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" /></svg>
  ),
};
